...
public class Book {
  ...
  public static ArrayList<String> queryGoogleBooks( String[] args) throws Exception {
 ...
 result.add(volgnummer+". "+volumeInfo.getTitle());
      ...
      if (authors != null && !authors.isEmpty()) {
        ...
        for (int i = 0; i < authors.size(); ++i) {
          ...
          result.add("Author: "+authors.get(i));
          if (i < authors.size() - 1) {
            //System.out.print(", ");
          }
        }
    ...
    return result;
     ...
     /* if (volumeInfo.getDescription() != null && volumeInfo.getDescription().length() > 0) {
       ...
       // result.add("Description: "+volumeInfo.getDescription());
      }
      // Ratings (if any).
 ...
 /* public static void searchbooks(String[] args) {
	 JsonFactory jsonFactory = JacksonFactory.getDefaultInstance();
